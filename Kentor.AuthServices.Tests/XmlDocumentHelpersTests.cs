...
namespace Kentor.AuthServices.Tests
{
    ...
    public class XmlDocumentHelpersTests
    {
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnWrongCert()
        {
            var xml = "<xml ID=\"someID\"><content>text</content></xml>";
            var xmlDoc = XmlDocumentHelpers.FromString(xml);
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnTamperedData()
        {
            var xml = "<xml ID=\"someID\"><content>text</content></xml>";
            var xmlDoc = XmlDocumentHelpers.FromString(xml);
            xmlDoc.Sign(SignedXmlHelper.TestCert);
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnMissingReferenceInSignature()
        {
            ...
            var xmlDoc = XmlDocumentHelpers.FromString(signedWithoutReference);
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnDualReferencesInSignature()
        {
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsInformativeMessageOnSha256Signature()
        {
            ...
            var xmlDoc = XmlDocumentHelpers.FromString(xmlSignedWithSha256);
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnTamperedData_WithSha256Signature()
        {
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_ThrowsOnIncorrectTransformsInSignature()
        {
        ...
        [TestMethod]
        public void XmlDocumentHelpers_IsSignedBy_HandlesMultipleSignaturesInSameDocument()
        {
