...
{
    [Test]
    [Arguments(DateTimeKind.Utc, false)]
    [Arguments(DateTimeKind.Unspecified, true)]
    [Arguments(DateTimeKind.Local, true)]
    ...
    public static IEnumerable<(DateTimeOffset, DateTimeUtc, bool)> DateTimeUtcOffset_Less_than_DateTimeUtc_Data() =>
        [
            // Same time is not less
            (
                new(2025, 01, 02, 03, 04, 05, TimeSpan.Zero),
                new(2025, 01, 02, 03, 04, 05),
                false
            ),
            // Less time is less
            (
                new(2025, 01, 02, 03, 04, 04, TimeSpan.Zero),
                new(2025, 01, 02, 03, 04, 05),
                true
            ),
            // Time in earlier timezone is less
            (
                new(2025, 01, 02, 03, 04, 05, TimeSpan.FromHours(1)),
                new(2025, 01, 02, 03, 04, 05),
                true
            ),
            ...
            (
                new(2025, 01, 02, 04, 04, 05, TimeSpan.FromHours(1)),
                new(2025, 01, 02, 03, 04, 05),
                false
            )
        ];
    ...
    [Test]
    [MethodDataSource(nameof(DateTimeUtcOffset_Less_than_DateTimeUtc_Data))]
    ...
    public static IEnumerable<(DateTimeOffset, DateTimeUtc, bool)> DateTimeUtcOffset_GreaterOrEqual_than_DateTimeUtc_Data() =>
        [
            ...
            (
                new(2025, 01, 02, 03, 04, 06, TimeSpan.Zero),
                new(2025, 01, 02, 03, 04, 05),
                true
            ),
            // Time in earlier timezone is less
    ...
    [Test]
    [MethodDataSource(nameof(DateTimeUtcOffset_GreaterOrEqual_than_DateTimeUtc_Data))]
