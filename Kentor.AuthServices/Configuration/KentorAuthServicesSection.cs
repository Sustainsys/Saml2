...
namespace Kentor.AuthServices.Configuration
{
    ...
    public class KentorAuthServicesSection : ConfigurationSection, ISPOptions
    {
        ...
        /// </summary>
        [TypeConverter(typeof(PendingAuthStorageContainerConverter))]
        [ConfigurationProperty("pendingAuthStorageContainer")]
        public IPendingAuthStorageContainer PendingAuthStorageContainer
        {
            get
            {
                pendingAuthStorageContainer = (IPendingAuthStorageContainer)base["pendingAuthStorageContainer"];
