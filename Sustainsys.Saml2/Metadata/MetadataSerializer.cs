...
namespace Sustainsys.Saml2.Metadata
{
	...
	public class MetadataSerializer
	{
		...
		protected virtual ContactPerson ReadContactPerson(XmlReader reader)
		{
			...
			{
				case "technical":
					person.Type = ContactType.Technical;
					break;
				case "support":
					person.Type = ContactType.Support;
					break;
				case "administrative":
					person.Type = ContactType.Administrative;
					break;
				case "billing":
					person.Type = ContactType.Billing;
					break;
				case "other":
					person.Type = ContactType.Other;
					break;
				default:
					throw new MetadataSerializationException($"<ContactPeson> with unknown contactType attribute '{contactType}'");
			}
			...
			ReadChildren(reader, () =>
			{
				if (reader.IsStartElement("Company"))
				{
					person.Company = reader.ReadElementContentAsString();
				}
				else if (reader.IsStartElement("GivenName"))
				{
				...
				else if (reader.IsStartElement("EmailAddress"))
				{
					person.EmailAddresses.Add(reader.ReadElementContentAsString());
				}
				else if (reader.IsStartElement("TelephoneNumber"))
				{
